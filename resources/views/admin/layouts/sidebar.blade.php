      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="nav-link" href="layout-transparent.html">Barra lateral transparente</a></li>
            <li><a class="nav-link" href="layout-top-navigation.html">Navegação superior</a></li>
          </ul>
        </li>
